                      ...
                      child: Row(
                        ...
                        children: [
                          Text(
                            'Verified',
                            style: TextStyle(
                              color: HexColor('#009D45'), // Match the text color to the icon
                            ),
                          ),
                          SizedBox(width: 4), // Add some spacing between text and image
                          Image.asset(
                            'assets/image/3.png',
                            width: 24,
                            height: 24,
              ...
              Container(
                ...
                child: TextButton(
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => ChangeSucessfuly()),
                    );
                  },
                  child: Text(
                    'Update',
